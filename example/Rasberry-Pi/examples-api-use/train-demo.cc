   ...
   void Run() override
{
  ...
  {
    // Daten nur alle 30 Sekunden neu holen
    if (counter % 30 == 0)
    {
      ok = FetchTrainData(station_abbr_, &trains, &error);
    }
  ...
  private:
                     ...
                     const std::string &error_message)
    {
      ...
      int mode = (now / 10) % 3; // wechselt alle 10 Sekunden
      ...
      for (size_t i = 0; i < trains.size() && y < matrix_->height(); i++)
      {
        ...
        case 1:
          ...
          {
            DrawLineText(x_time, y, Color(255, 0, 0), "+" + t.delay);
          }
          break;
        ...
        case 2:
          ...
          if (t.has_platform)
          {
            DrawLineText(x_time, y, Color(255, 200, 0), t.platform);
          }
          break;
        }
